...
namespace NSE.Identidade.API.Controllers
{
    ...
    public class AuthController : MainController
    {
        ...
        public async Task<ActionResult> Login(UsuarioLogin usuarioLogin)
        {
            ...
            //a linha abaixo tem uma opção de parametro que esta setado como true é para bloquear o usuario caso tenha muitas tentativas de login inválidas
            ...
            //usuario bloqueado por tentativas inválidas
